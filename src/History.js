    ...
    useEffect(() => {
        ...
        axios.post('https://rpl2-server.my.id/api/getdata')
            .then(response => {
                ...
                console.log('Data dari server:', response.data.reservations);
                ...
                <div className="overlap-group-wrapper">
                    <div className="overlap-group">
                        ...
                        <div className="list">
                            <div className="list2">
                            {dummyData.map((data) => (
                                <div key={`${data.id}-${data.status}`} className={`reservation-button ${data.status}`} onClick={() => handleReservationButtonClick(data)}>
